...
# gene_names <- scan('data/AD-PPI-intprots.txt', what = '', sep = '\n')
gene_names <- scan('data/AD_Multi_intprots.txt', what = '', sep = '\n')
...
lapply(sptdf, function(DF){
  ...
  outfile <- paste0('data/BED_files/AD_Multi/chr', outfile, '.genes.bed')
